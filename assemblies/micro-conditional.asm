...
move 80 rsp rax
restore-state
stay-to conditional-init $2
set aedaed r8
move-quad r8 conditional-code
stay-to conditional-com always
marker conditional-init
set aed r8
move-quad r8 conditional-code
marker conditional-com
...
set 8 rdx
leeve-quad conditional-code rsi
set 1 rax
syscall
