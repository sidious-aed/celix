...
auto-quad-source time-seconds
auto-quad-source time-micro-seconds
auto-quad-source time-zones-1
auto-quad-source time-zones-2

# gettimeofday
leeve-quad time-seconds rdi
leeve-quad time-zones-1 rsi
set 60 rax
syscall
