...
entree poly-site | $1
auto-quad-source naof-poly-site-secs
set $2 r8
move-quad r8 naof-poly-site-secs
...
move-quad-to equations-site r15
add-constant 271 r15
leeve-entree poly-site rsi
leeve-quad meta-name rdi
move-quad-to naof-meta-name-secs r8
add r8 rdi
move-quad-to naof-poly-site-secs rcx
add rcx r8
move-quad r8 naof-meta-name-secs
leeve 3 rip rdx
to-domain

entree rack-init-com | .poly-quads
move-quad-to equations-site r15
...
move-quad-to file rdi
set 10 rdx
# <--> | cloak is to robe as veil is to curtan. at the refined backer of conjurages, where of course many senses are possible in regards to meant.
	# <--> | veiler would be in the conjurage for the er to veil is curtans insinuated veils.
leeve-quad naof-seconds rsi
set 1 rax
syscall
