...
add-to-rack-site 200
auto-quad-source stat-name
add-to-rack-site 200
auto-quad-source naof-stat-name-secs
auto-quad-source sched-name
add-to-rack-site 200
auto-quad-source naof-sched-name-secs
auto-quad-source schedstat-name
add-to-rack-site 200
auto-quad-source naof-schedstat-name-secs
...
move-quad-to equations-site r15
move-quad-to entrees-site rsi
add-constant 16c rsi
leeve-quad stat-name rdi
move-quad-to naof-meta-name-secs r8
add r8 rdi
set a rcx
add rcx r8
move-quad r8 naof-stat-name-secs
add-constant 271 r15
leeve 3 rip rdx
to-domain

leeve-quad stat-name rsi
move-quad-to naof-stat-name-secs r8
add r8 rsi
naoify r8
move-sec-to 0 r8 rsi
...
set 1 rdi
leeve-quad stat-name rsi
move-quad-to naof-stat-name-secs rdx
set 1 rax
syscall
...
move-quad-to equations-site r15
move-quad-to entrees-site rsi
add-constant 194 rsi
leeve-quad sched-name rdi
move-quad-to naof-meta-name-secs r8
add r8 rdi
set b rcx
add rcx r8
move-quad r8 naof-sched-name-secs
add-constant 271 r15
leeve 3 rip rdx
to-domain

leeve-quad sched-name rsi
move-quad-to naof-sched-name-secs r8
add r8 rsi
naoify r8
move-sec-to 0 r8 rsi
...
set 1 rdi
leeve-quad sched-name rsi
move-quad-to naof-sched-name-secs rdx
set 1 rax
syscall
...
move-quad-to equations-site r15
move-quad-to entrees-site rsi
add-constant 1a0 rsi
leeve-quad schedstat-name rdi
move-quad-to naof-meta-name-secs r8
add r8 rdi
set f rcx
add rcx r8
move-quad r8 naof-schedstat-name-secs
add-constant 271 r15
leeve 3 rip rdx
to-domain

leeve-quad schedstat-name rsi
move-quad-to naof-schedstat-name-secs r8
add r8 rsi
naoify r8
move-sec-to 0 r8 rsi
...
set 1 rdi
leeve-quad schedstat-name rsi
move-quad-to naof-schedstat-name-secs rdx
set 1 rax
syscall
...
auto-quad-source sched-proc-name
add-to-rack-site 200
auto-quad-source naof-sched-proc-name-secs

move-quad-to equations-site r15
move-quad-to entrees-site rsi
add-constant bd rsi
leeve-quad sched-proc-name rdi
set 6 rcx
add-constant 271 r15
leeve 3 rip rdx
to-domain
...
move-quad-to equations-site r15
add-constant 1 r15
leeve-quad sched-proc-name rsi
add-constant 6 rsi
set a rbx
move-quad-to pid rdi
leeve 3 rip rdx
...
set 6 r8
add rax r8
move-quad r8 naof-sched-proc-name-secs

move-quad-to equations-site r15
move-quad-to entrees-site rsi
add-constant 182 rsi
leeve-quad sched-proc-name rdi
move-quad-to naof-sched-proc-name-secs r8
add r8 rdi
set 6 rcx
add rcx r8
move-quad r8 naof-sched-proc-name-secs
...
set 1 rdi
leeve-quad sched-proc-name rsi
move-quad-to naof-sched-proc-name-secs rdx
set 1 rax
syscall
...
stay-to write-sched-init signed-equal-below
marker write-sched-com
...
auto-quad-source schedstat-proc-name
add-to-rack-site 200
auto-quad-source naof-schedstat-proc-name-secs

move-quad-to equations-site r15
move-quad-to entrees-site rsi
add-constant bd rsi
leeve-quad schedstat-proc-name rdi
set 6 rcx
add-constant 271 r15
leeve 3 rip rdx
to-domain
...
move-quad-to equations-site r15
add-constant 1 r15
leeve-quad schedstat-proc-name rsi
add-constant 6 rsi
set a rbx
move-quad-to pid rdi
leeve 3 rip rdx
...
set 6 r8
add rax r8
move-quad r8 naof-schedstat-proc-name-secs

move-quad-to equations-site r15
move-quad-to entrees-site rsi
add-constant 1b0 rsi
leeve-quad schedstat-proc-name rdi
move-quad-to naof-schedstat-proc-name-secs r8
add r8 rdi
set a rcx
add rcx r8
move-quad r8 naof-schedstat-proc-name-secs
...
set 1 rdi
leeve-quad schedstat-proc-name rsi
move-quad-to naof-schedstat-proc-name-secs rdx
set 1 rax
syscall
...
syscall
compair-constant 0 rax
stay-to write-schedstat-init signed-equal-below
marker write-schedstat-com
